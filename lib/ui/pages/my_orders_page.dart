              ...
              child: SingleChildScrollView(
                  ...
                  child: Obx(() {
                    return IndexedStack(
                      ...
                      children: [
                        _controller.isShippingOrdersLoading.value
                            ? SizedBox(
                                height:
                                    MediaQuery.of(context).size.height - 160,
                                child: const Loading())
                            : _controller.shippingOrders.isEmpty
                                ? SizedBox(
                                ...
                                : Column(
                                    children:
                                        _controller.shippingOrders.map((order) {
                                      return Material(
                                        color: BG_COLOR,
                                        child: InkWell(
                                          onTap: () => Get.toNamed(
                        ...
                        _controller.isDeliveredOrdersLoading.value
                            ? SizedBox(
                                height:
                                    MediaQuery.of(context).size.height - 160,
                                child: const Loading())
                            : _controller.deliveredOrders.isEmpty
                                ? SizedBox(
                                    height: MediaQuery.of(context).size.height -
                                        160,
                                    child: Center(
                                ...
                                : Column(
                                    children: _controller.deliveredOrders
                                        .map((order) {
                                      return Material(
                                        color: BG_COLOR,
                                        child: InkWell(
                        ...
                        _controller.isCancelledOrdersLoading.value
                            ? SizedBox(
                                height:
                                    MediaQuery.of(context).size.height - 160,
                                child: const Loading())
                            : _controller.cancelledOrders.isEmpty
                                ? SizedBox(
                                    height: MediaQuery.of(context).size.height -
                                        160,
                                    child: Center(
                                ...
                                : Column(
                                    children: _controller.cancelledOrders
                                        .map((order) {
                                      return Material(
                                        color: BG_COLOR,
                                        child: InkWell(
